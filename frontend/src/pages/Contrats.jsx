...
//   const [selectedContrat, setSelectedContrat] = useState(null); // Contrat sélectionné pour mise à jour
...
//   const [nom, setNom] = useState(selectedContrat?.nom || "");
//   const [type, setType] = useState(selectedContrat?.type || "simple");
//   const [prixTotal, setPrixTotal] = useState(selectedContrat?.prixTotal || "");
//   const [prixAvance, setPrixAvance] = useState(
//     selectedContrat?.prixAvance || ""
//   );
//   const [delaisTraitement, setDelaisTraitement] = useState(
//     selectedContrat?.delaisTraitement || ""
//   );
//   const token = localStorage.getItem("token");
    ...
    <div className="bg-base-200 min-h-screen">
      ...
      <div className="p-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {contrats.map((c) => (
            <div key={c._id} className="card bg-white shadow-md p-4">
